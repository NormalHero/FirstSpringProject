			...
			<div class="row">
				...
				<div class="col-xs-8 text-right menu-1">
					<ul>
						...
						<li class="btn-cta"><a href="login.jsp"><span>로그인/회원가입</span></a></li>
					</ul>	
				</div>
			</div>
				...
				<div class="col-md-12 text-center">
					<div class="gtco-widget">
						...
						<ul class="gtco-quick-contact">
							<li><a href="#"><i class="icon-phone"></i> 	070-8802-4140</a></li>
					...
					<div class="gtco-widget">
						...
						<ul class="gtco-social-icons">
							<li><a href="https://www.instagram.com/cafe_n.wave/"><i class="icon-linkedin"></i></a></li>
						</ul>
					</div>
				</div>
